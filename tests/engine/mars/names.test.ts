...
import { MARS_FIRST_NAMES, MARS_LAST_NAMES, MARS_CHILD_NAMES, MARS_DEPARTMENT_DISTRIBUTION, MARS_SPECIALIZATIONS } from '../../../src/engine/mars/names.js';
import { MARS_DEFAULT_KEY_PERSONNEL, MARS_DEFAULT_LEADERS } from '../../../src/engine/mars/presets.js';
