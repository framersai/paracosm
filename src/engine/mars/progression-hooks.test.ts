...
test('marsProgressionHook accumulates radiation per yearDelta', () => {
  ...
  marsProgressionHook({ colonists: [c], yearDelta: 1, year: 2036, turn: 1, startYear: 2035, rng: { chance: () => false } as any });
...
test('marsProgressionHook uses slower bone loss rate for Mars-born', () => {
  ...
  marsProgressionHook({ colonists: [earthBorn], yearDelta: 1, year: 2036, turn: 1, startYear: 2035, rng });
  marsProgressionHook({ colonists: [marsBorn], yearDelta: 1, year: 2036, turn: 1, startYear: 2035, rng });
